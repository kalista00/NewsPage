...
> **제작 기간:** 2023.04 ~ 05.
>
> **주요 기능:** 검색, 로그인, 메인, 언론사/회원 페이지, 구독/스크랩현황, 기사페이지, 글쓰기
>
...
<img width="100%" alt="기사페이지" src="https://github.com/kalista00/NewsPage/assets/122184547/96c60678-7de6-4739-a680-b64d13ac3be6" />

- url복사가 가능하도록 구현
- 글씨크기 조절이 가능하도록 구현
- 기자이름를 누르면 해당기자 페이지로 이동하도록 구현
- 댓글기능 구현
  
### **7. 글쓰기**

<img width="100%" alt="기사페이지" src="https://github.com/kalista00/NewsPage/assets/122184547/3c23dcc1-7498-454e-b73a-51ba89393682" />
